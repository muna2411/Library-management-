...
<button className="btn bg-[#A0522D] text-white" onClick={ () =>document.getElementById('my_modal_5').showModal()}>Borrow</button>
  ...
  <div className="modal-box">
   <img className="w-[250px] h-[250px] ml-[100px]" src="https://i.ibb.co/dbPg8qS/hi.png"></img>
    ...
    <div className="form-control m-[50px]">
      ...
      <form method="dialog">
      <Link to={'/mycart'}  onClick={handlecheckout} className="btn  bg-[#87CEEB] ">Submit</Link>
      </form>
    </div>
                ...
                <button onClick={handleGoBack} className="btn" style={{ border: "3px solid black" }}>Read</button>
                    </div>
                </div>
                </div>

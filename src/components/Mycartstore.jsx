...
const Mycartstore = ({user,users,setUsers}) => {
    const  {_id,name,author,category_name,image ,returndate,quantity} = user;
        ...
        <div >
            <div className="card w-[450px] bg-base-100 shadow-xl my-[100px] lg:ml-[50px] sm:ml-[100px] hero  ">
               <figure><img className="w-[450px] h-[650px]" src={image} alt="Shoes" /></figure>
                ...
                <div>
                    <Link >
                        <button  onClick={() => handleDelete(_id)} className="btn  mb-[550px] w-[350px] h-[50px] text-[18px]" >Return Book</button>
                    </Link>
                    </div>
            </div>
        </div>

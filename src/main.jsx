    ...
    children:[
      {
        path:"/",
        element:<Home></Home>,
        loader: () => fetch('https://library-management-server-2ad0qlyqe-munas-projects.vercel.app/service')
      },
      {
        path:"/addbook",
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://library-management-server-2ad0qlyqe-munas-projects.vercel.app/book/${params.id}`)
       },
      {
         path:'/login',
         element:<Login></Login>
...

     {
      ...
      },
      {
        path:'/mycart/:id',
        element:<PrivateRoutes><MyCart></MyCart></PrivateRoutes>,
        loader:({params}) =>  fetch(`https://library-management-server-2ad0qlyqe-munas-projects.vercel.app/cart/${params.id}`)
      },
      {
        path:'/pdf',
